<?php
session_start();
$koneksi = mysqli_connect("localhost", "root", "", "vyystore");
if (isset($_POST["add"])) {
...
if (isset($_GET["action"])) {
    if ($_GET["action"] == "delete") {
        foreach ($_SESSION["cart"] as $keys => $value) {
            ...
            $alamat = $_POST['alamat'];
            $sql = mysqli_query($koneksi, "INSERT INTO transaksi(total,tgl_transaksi,id_pembeli,username,alamat) value ('$total','".date("Y-m-d")."','$id_pembeli','$username','$alamat')");
            //$sql = mysqli_query($koneksi, "INSERT INTO dibeli(total_harga,total_barang,tgl_transaksi,id_pembeli,alamat) VALUES ('$total','".date("Y-m-d")."','$id_pembeli','$alamat')");
            }
    ...
    echo "<script>window.location='cetak1.php?id=".$id_transaksi."'</script>";
} 
}
?>
        ...
        <div class="row justify-content-center ">
            <div class="col-xl-10">
                <div class="card shadow-lg ">
                    ...
                    <form action="cart2.php?action=beli"  method="POST">
                                            ...
                                            <div class="row  justify-content-between">
                                                <div class="col-auto col-md-7">
                                                    <div class="media flex-column flex-sm-row">
                                                        <img class="rouned" src="img/<?=$value['foto']?>" width="62" height="62">
